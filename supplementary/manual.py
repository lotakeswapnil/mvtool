    ...
    if manual_data == 'No':
            ...
            if tmy == 'Yes':
                ...
                if len(baseline_df) >= 2:
                    ...
                    if st.button("Fetch Weather Data & Calculate Savings"):
                        ...
                        status.text("Fetching baseline period temperatures...")
                        ...
                        status.text("Fetching reporting period temperatures...")
                        ...
                        status.text("Fitting baseline models...")
                        ...
                        status.text("Fitting reported models...")
                        ...
                        status.text("Generating baseline model results plots...")
                        ...
                        status.text("Generating reported model results and plots...")
                        ...
                        status.text("Calculating TMY predictions and savings...")
            ...
            if tmy == 'No':
                ...
                if len(baseline_df) >= 2:
                    ...
                    if st.button("Fetch Weather Data & Calculate Savings"):
                        ...
                        status.text("Calculating Savings...")
        ...
        if interval == 'No':
            ...
            if tmy == "Yes" or tmy == "No":
                ...
                with start_b:
                    start_date_b = st.date_input('Baseline Start Date', max_value=date.today()-timedelta(days=2))
                with end_b:
                    end_date_b = st.date_input('Baseline End Date', max_value=date.today()-timedelta(days=1))
                with weather_int_b:
                ...
                with start_r:
                    start_date_r = st.date_input('Reported Start Date', max_value=date.today()-timedelta(days=2))
                with end_r:
                    end_date_r = st.date_input('Reported End Date', max_value=date.today()-timedelta(days=1))
                with weather_int_r:
